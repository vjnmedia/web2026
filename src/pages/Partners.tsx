...
const Partners = () => {
  ...
  const partners: Partner[] = [
    ...
    },
    {
      ...
      description: 'The term "RTB mandate" most commonly refers to the mandate of the Rwanda TVET Board, which is to develop and promote quality technical and vocational education and training (TVET) in Rwanda.',
      website: 'https://rtb.gov.rw',
      location: 'Kigali, Rwanda',
      partnershipStart: '2017',
      focusAreas: ['Education', 'Training', 'Youth Empowerment'],
      impact: 'building trainer capacity',
      testimonial: {
        quote: 'Its core responsibilities include designing curricula, promoting the use of ICT in TVET, coordinating programs, building trainer capacity, and advising the government on policies to fast-track TVET development.',
        author: ' Rwanda TVET Board',
        position: 'Government of Rwanda'
      }
    },
    ...
    {
      id: '37',
      name: 'FIC: Frères d\'Instruction Chrétienne',
      category: 'NGO',
      type: 'Community',
      logo: '/images/partners/fic.jpg',
      description: 'Les "Frères d\'Instruction Chrétienne" font référence à l\'un des ordres religieux catholiques dédiés à l\'éducation, fondé par Jean-Marie de La Mennais à Ploërmel en 1819.',
