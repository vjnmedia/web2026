...
const Programs = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <section className="mb-8">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <Link to="/about">
              <Button variant="outline" className="border-2 border-gray-900 text-gray-900 hover:bg-gray-900 hover:text-white px-4 py-2 rounded-full">
                {t('programs.intro.learnMore', 'Learn More About Us')}
                <ChevronRight className="ml-2 h-4 w-4" />
              </Button>
            </Link>
            <Link to="/contact">
              <Button className="bg-gray-900 text-white hover:bg-gray-800 px-4 py-2 rounded-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {programs.map((program, index) => (
          <Link 
            ...
            className="group"
          >
            <div className={`bg-gradient-to-br from-${program.color}-50 to-white rounded-xl shadow-lg p-6 h-full transition-all duration-300 hover:shadow-xl hover:-translate-y-1`}>
              <div className={`text-${program.color}-600 mb-4 group-hover:scale-110 transition-transform duration-300`}>
                {program.icon}
              </div>
              <h3 className={`text-xl font-bold text-${program.color}-900 mb-3`}>
                {program.title}
              </h3>
      ...
      <section className="mt-8 bg-gray-900 rounded-xl p-8">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link to="/volunteer">
              <Button className="bg-white text-gray-900 hover:bg-gray-100 px-6 py-4 text-base rounded-full shadow-lg hover:shadow-xl transition-all">
                {t('programs.cta.volunteer', 'Volunteer With Us')}
                <ChevronRight className="ml-2 h-4 w-4" />
              </Button>
            </Link>
            <Link to="/donate">
              <Button variant="outline" className="border-2 border-white text-white hover:bg-gray-800 px-6 py-4 text-base rounded-full shadow-lg hover:shadow-xl transition-all">
